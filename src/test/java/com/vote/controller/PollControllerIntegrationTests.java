...
//		String jsonPayload = "{\"question\":\"Who will win?\",\"picks\":[{\"pickOption\":\"Team A\",\"count\":0}]}";
		...
		mockMvc.perform(MockMvcRequestBuilders.post("/polls").content(jsonPayload).contentType(MediaType.APPLICATION_JSON)).andExpect(MockMvcResultMatchers.status().isBadRequest());
